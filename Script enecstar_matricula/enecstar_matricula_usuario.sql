...
CREATE TABLE `usuario` (
  ...
  `nombres` varchar(65) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `apellidos` varchar(65) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `identidad` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
