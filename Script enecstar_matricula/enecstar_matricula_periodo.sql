...
CREATE TABLE `periodo` (
  ...
  `periodo` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `periodo` VALUES (1,'I','Prmer Periodo'),(2,'II','Segundo Periodo'),(3,'III','Tercer Periodo'),(4,'IV ','Cuarto Periodo');
